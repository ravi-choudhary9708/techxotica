...
export const eventItems: EventData[] = [
    ...
    // ✅ NEW
    {
        ...
        title: "CAD-CAM",
        category: "Technical",
        description: "Bridge the gap between design and manufacturing. Use CAD-CAM tools to design parts and generate machining toolpaths.",
        ...
        rules: [
            ...
            "Judging criteria: precision, efficiency of toolpath, and material optimization.",
        ],
    },
    // ✅ NEW
    {
        ...
        title: "3D Printing",
        category: "Technical",
        description: "From filament to form. Design and print functional prototypes that push the boundaries of additive manufacturing.",
        image: "https://images.unsplash.com/photo-1631378895015-3a02ca3e9c0e?q=80&w=1000&auto=format&fit=crop",
        color: "#ffd700",
        date: "23-24 March 2026",
        ...
        rules: [
            ...
            "Judging based on design complexity, structural integrity, and finish quality.",
        ],
    },
    // ✅ NEW
    {
        ...
        category: "Technical",
        description: "Simulate stress, flow, and motion. Use FEA and CFD tools to virtually test engineering designs before they're built.",
        image: "https://images.unsplash.com/photo-1635070041078-e363dbe005cb?q=80&w=1000&auto=format&fit=crop",
        color: "#ffd700",
        date: "24 March 2026",
        time: "10:00 AM - 01:00 PM",
        venue: "Simulation Lab, Mech Block",
        prizePool: "₹10,000",
        teamSizeText: "1-2 Members",
        rules: [
            "Allowed software: ANSYS, SOLIDWORKS Simulation, or COMSOL.",
            "Problem statement will be provided on the day of the event.",
            "Report with simulation results and analysis must be submitted within the time limit.",
        ],
    },
    // ✅ NEW
    {
        ...
        title: "Tesla Talk",
        category: "Technical",
        description: "Electrify the stage with your knowledge of electrical engineering. Present innovations in power systems, EVs, or renewable energy.",
        ...
        rules: [
            ...
            "Use of demonstrations or working models will earn bonus points.",
        ],
    },
    // ✅ NEW
    {
        ...
        title: "Line Follower",
        category: "Technical",
        description: "Program a bot to trace the path. Speed and precision are everything as your robot races along the track.",
        image: "https://images.unsplash.com/photo-1561144257-e32e8506c987?q=80&w=1000&auto=format&fit=crop",
        color: "#ffd700",
        date: "23 March 2026",
        ...
        rules: [
            ...
            "Three timed runs per team; the best time counts.",
        ],
    },
    // ✅ NEW
    {
        ...
        rules: [
            ...
            "Points deducted for each edge contact; falling off results in round elimination.",
        ],
    },
    // ✅ NEW
    {
        ...
        title: "Robbo Soccer",
        category: "Technical",
        description: "The beautiful game, reimagined with machines. Program your robot to outmaneuver, pass, and score against the opposition.",
    ...
    {
        id: "radium-cricket",
        title: "Radium Cricket",
        category: "Gaming",
        description: "Cricket after dark. Glow-in-the-dark equipment, UV lights, and neon stumps make this a night match like no other.",
        image: "https://images.unsplash.com/photo-1531415074968-036ba1b575da?q=80&w=1000&auto=format&fit=crop",
        color: "#a855f7",
        date: "23 March 2026",
        time: "07:00 PM - 10:00 PM",
        venue: "Sports Ground, GEC Madhubani",
        prizePool: "₹15,000",
        teamSizeText: "8 Members",
        rules: [
            "Radium/glow equipment will be provided by the organizers.",
            "Standard cricket rules apply with modifications for the night format.",
            "Each innings is limited to 6 overs.",
